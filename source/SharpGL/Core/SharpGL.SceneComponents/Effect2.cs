...
namespace SharpGL.SceneComponents
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Effect2"/> class.
        /// </summary>
        public Effect2()
        {
            Name = "Effect";
        ...
        public abstract void Push(OpenGL gl, SceneElement2 parentElement);
        ...
        /// <param name="gl">The OpenGL instance.</param>
        /// <param name="parentElement">The parent element.</param>
        public abstract void Pop(OpenGL gl, SceneElement2 parentElement);
