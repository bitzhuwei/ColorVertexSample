...
namespace SharpGL.SceneComponents
{
    ...
    /// </summary>
    public class OpenGLAttributesEffect2 : Effect2
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenGLAttributesEffect2"/> class.
        /// </summary>
        public OpenGLAttributesEffect2()
        {
        ...
        public override void Push(OpenGL gl, SceneElement2 parentElement)
        {
        ...
        /// <param name="gl">The OpenGL instance.</param>
        /// <param name="parentElement">The parent element.</param>
        public override void Pop(OpenGL gl, SceneElement2 parentElement)
        {
