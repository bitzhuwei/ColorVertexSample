...
namespace SharpGL.SceneComponents
{
    ...
    /// </summary>
    [Serializable()]
    public class Cylinder2 : Quadric2, IVolumeBound
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Cylinder2"/> class.
        /// </summary>
        public Cylinder2() 
        { 
            //  Set the name.
        ...
        /// </summary>
        private BoundingVolumeHelper2 boundingVolumeHelper = new BoundingVolumeHelper2();
