...
namespace SharpGL.SceneComponents
{
    public partial class SceneElement2
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<SceneElement2> Traverse()
        {
        ...
        /// <returns></returns>
        public IEnumerable<SceneElement2> Traverse(Predicate<SceneElement2> predicate)
        {
            //  Go through each child element...
            foreach (var sceneElement in children)
            {
        ...
        public IEnumerable<T> Traverse<T>() where T : SceneElement2
        {
            //  Go through each child element...
            foreach (var sceneElement in children)
            {
        ...
        /// </returns>
        public IEnumerable<T> Traverse<T>(Predicate<T> predicate) where T : SceneElement2
        {
            //  Go through each child element...
            foreach (var sceneElement in children)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public SceneContainer2 TraverseToRootElement()
        {
            ...
            return current as SceneContainer2;
        }
    }
}
