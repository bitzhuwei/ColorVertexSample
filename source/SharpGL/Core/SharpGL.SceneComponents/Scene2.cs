...
namespace SharpGL.SceneComponents
{
    ...
    [XmlInclude(typeof(LookAtCamera2))]
    [XmlInclude(typeof(ArcBallCamera))]
	public class Scene2 : IHasOpenGLContext
	{
        /// <summary>
		...
		public virtual IEnumerable<SceneElement2> DoHitTest(int x, int y)
		{
            //  Create a result set.
            List<SceneElement2> resultSet = new List<SceneElement2>();

            //  Create a hitmap.
            Dictionary<uint, SceneElement2> hitMap = new Dictionary<uint, SceneElement2>();
		...
		/// </summary>
		public virtual void Draw(Camera2 camera = null)
		{
        ...
        public void RenderElement(SceneElement2 sceneElement, RenderMode renderMode)
        {
        ...
        private void RenderElementForHitTest(SceneElement2 sceneElement, 
            Dictionary<uint, SceneElement2> hitMap, ref uint currentName)
        {
            //  If the element is disabled, we're done.
        ...
        public void CreateInContext(OpenGL gl)
        {
            ...
            var openGLContextElements = SceneContainer.Traverse<SceneElement2>(
        ...
        /// </summary>
        private SceneContainer2 sceneContainer = new SceneContainer2();
        ...
        public SceneContainer2 SceneContainer
        {
