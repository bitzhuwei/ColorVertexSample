...
{
    public partial class FormTexture2dHexahedronGridderElement_DrawElements : Form
    {
        public FormTexture2dHexahedronGridderElement_DrawElements()
        {
            InitializeComponent();
        ...
        private void Create3DObject(object sender, EventArgs e)
        {
            try
            {
                ...
                Texture2dHexahedronGridderElement_DrawElements gridderElement = new Texture2dHexahedronGridderElement_DrawElements(
                    textureImage, source, this.scientificVisual3DControl.Scene.CurrentCamera);
