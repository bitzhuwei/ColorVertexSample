...
{
    public partial class FormDynamicUnStructuredGridderElement : Form
    {
        private DynamicUnStructuredGridderElement element;

        public FormDynamicUnStructuredGridderElement()
        {
            InitializeComponent();
        ...
        private void Create3DObject(object sender, EventArgs e)
        {
            try
            {
                ...
                this.element = new DynamicUnStructuredGridderElement(source, this.scientificVisual3DControl.Scene.CurrentCamera) { Name = "UnStructuredGridderElement}" };
