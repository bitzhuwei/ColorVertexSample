...
{
    public class Well : SharpGL.SceneGraph.Core.SceneElement, SharpGL.SceneGraph.Core.IRenderable
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            var vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"Well.vert");
            var fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"Well.frag");
