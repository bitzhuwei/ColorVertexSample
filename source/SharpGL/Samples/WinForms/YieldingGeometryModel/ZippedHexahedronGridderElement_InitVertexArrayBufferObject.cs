...
{
    public partial class ZippedHexahedronGridderElement
    {
        private int vertexCount;
        private int[] firsts;
        private int[] counts;

        private void InitVertexes(OpenGL gl, UnmanagedArray<Vertex> vertexes, UnmanagedArray<uint> colorArray, UnmanagedArray<float> visibles)
        {
            uint[] vao = new uint[1];
            ...
            gl.VertexAttribPointer(ATTRIB_INDEX_COLOUR, 1, OpenGL.GL_UNSIGNED_INT, false, 0, IntPtr.Zero);
        ...
        public void UpdateColorBuffer(OpenGL gl, UnmanagedArray<uint> colors, UnmanagedArray<float> visibles)
        {
