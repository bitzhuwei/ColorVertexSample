...
namespace YieldingGeometryModel.FontResources
{
    /// <summary>
    /// 含有字形贴图及其配置信息的单例类型。
    /// </summary>
    public sealed class FontResource : IDisposable
    {
        ...
        {
            this.FontBitmap = ManifestResourceLoader.LoadBitmap("FontResources.LucidaTypewriterRegular.ttf.png");

            string xmlContent = ManifestResourceLoader.LoadTextFile("FontResources.LucidaTypewriterRegular.ttf.xml");
