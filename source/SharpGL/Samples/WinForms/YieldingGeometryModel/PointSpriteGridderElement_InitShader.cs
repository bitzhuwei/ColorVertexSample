        ...
        {
            {
                ...
                var vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"PointSpriteGridderElement.vert");
                var fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"PointSpriteGridderElement.frag");
