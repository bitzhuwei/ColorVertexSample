...
namespace YieldingGeometryModel
{
    public partial class ZippedHexahedronGridderElement
    {
        ...
        {
            String vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"ZippedHexahedronGridderElement.vert");
            String fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"ZippedHexahedronGridderElement.frag");
