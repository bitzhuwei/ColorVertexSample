...
{
    public partial class PointSpriteGridderElement : IDisposable
    {
        ...
        protected void CleanUnmanagedRes()
        {
            ...
            var buffers = new uint[] { this.positionBuffer, this.radiusBuffer, this.colorBuffer, this.visualBuffer };
