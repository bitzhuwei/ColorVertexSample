...
namespace YieldingGeometryModel
{
    public partial class DynamicUnStructuredGridderElement
    {
        ...
        {
            String vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"DynamicUnStructuredGridderElement.vert");
            String fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"DynamicUnStructuredGridderElement.frag");
