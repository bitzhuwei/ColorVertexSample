...
namespace YieldingGeometryModel
{
    ...
    public class CylinderElement : SharpGL.SceneGraph.Core.SceneElement, SharpGL.SceneGraph.Core.IRenderable
    {
        ...
        {
            var vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"CylinderElement.vert");
            var fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"CylinderElement.frag");
