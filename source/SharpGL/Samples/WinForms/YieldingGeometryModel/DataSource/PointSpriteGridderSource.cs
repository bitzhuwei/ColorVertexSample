...
namespace YieldingGeometryModel
{
    ...
    /// </summary>
    public abstract class PointSpriteGridderSource : GridderSource
    {
        ...
        /// <param name="k"></param>
        /// <returns></returns>
        public abstract Vertex GetPosition(int i, int j, int k);
        ...
        /// <param name="k"></param>
        /// <returns></returns>
        public abstract float GetRadius(int i, int j, int k);
