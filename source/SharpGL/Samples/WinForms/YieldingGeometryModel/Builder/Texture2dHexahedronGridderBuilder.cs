...
namespace YieldingGeometryModel.Builder
{
        ...
        IDisposable
    {
        ...
        /// 颜色
        /// </summary>
        public UnmanagedArray<UVF> VertexColors { get; set; }
    ...
    public class Texture2dHexahedronGridderHelper
    {
        ...
        /// <returns></returns>
        public static UnmanagedArray<UVF> FromColors(HexahedronGridderSource source, int[] gridIndexes, UVF[] colors, UnmanagedArray<float> visibles)
        {
            UnmanagedArray<UVF> colorArray = new UnmanagedArray<UVF>(source.DimenSize * HEXAHEDRON_VERTEX_COUNT);
        ...
        public static Texture2dMeshGeometry CreateMesh(HexahedronGridderSource source)
        {
    ...
    // 此处的代码应独立出来。
    //public static class Texture2dHexahedronGridderBuilder
    //{
