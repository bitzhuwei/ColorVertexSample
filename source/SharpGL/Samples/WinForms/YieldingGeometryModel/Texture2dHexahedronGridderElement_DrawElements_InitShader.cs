...
namespace YieldingGeometryModel
{
    public partial class Texture2dHexahedronGridderElement_DrawElements
    {
        ...
        {
            String vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"Texture2dHexahedronGridderElement_DrawElements.vert");
            String fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"Texture2dHexahedronGridderElement_DrawElements.frag");
