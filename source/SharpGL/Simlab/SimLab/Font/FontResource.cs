...
namespace SimLab.Font
{
    ...
    public sealed class FontResource : IDisposable
    {
        ...
        {
            this.FontBitmap = ManifestResourceLoader.LoadBitmap("Font.LucidaTypewriterRegular.ttf.png");

            string xmlContent = ManifestResourceLoader.LoadTextFile("Font.LucidaTypewriterRegular.ttf.xml");
