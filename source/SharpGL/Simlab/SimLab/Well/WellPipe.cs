...
namespace Simlab.Well
{
    ...
    public class WellPipe : SharpGL.SceneGraph.Core.SceneElement, SharpGL.SceneGraph.Core.IRenderable, IDisposable
    {
        ...
        {
            var vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"Well.WellPipe.vert");
            var fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"Well.WellPipe.frag");
